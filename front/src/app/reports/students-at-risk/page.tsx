...
import { getStudentsAtRisk, StudentAtRisk } from '../../../../services/risk.service';
...
export default async function StudentsAtRiskPage(props: {
  ...
  const pageSize = 10;
  const students = await getStudentsAtRisk(searchTerm, currentPage, pageSize);
    ...
    <main className={styles.wrapper}>
      <header className={styles.header}>
        ...
        <div className={styles.insightBox}>
          <p>
            <strong>Insight:</strong> Este reporte identifica estudiantes vulnerables por faltas o promedio menor a 80.
          </p>
        </div>
